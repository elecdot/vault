...
| fonts-noto-cjk      | 2026-05-19 | 1:20230817+repack1-3  | alive   | For Chinese figure support (config with `~/.config/matplotlib/matplotlibrc`), maybe align WSL and Windows later. |
