...
2. **Choose the template home**: decide whether the template is a general cross-kind entry point or a kind-specific family, and follow the local `templates/AGENTS.md` placement rules.
